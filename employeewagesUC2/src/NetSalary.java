...
abstract class IEmployeeWageComputation
{
    public abstract void addCompany(int wagePerHr, int maxWorkingDays, int maxWorkingHrs);

    public abstract void calculateTotalWage();

    public abstract int getTotalEmpWage(String companyName);
}
...
class CompanyEmpWage
{
    ...
    public String toString() {
        ...
        return "Total wage for a month of "  + " employee is " + totalEmpWage + "\n";
    }
}

class EmployeeWageComputation extends IEmployeeWageComputation {
    // class constants
    ...
    {
        CompanyEmpWage company = new CompanyEmpWage(wagePerHr, maxWorkingDays, maxWorkingHrs);
    ...
    @Override
    public void addCompany(int wagePerHr, int maxWorkingDays, int maxWorkingHrs) {
        CompanyEmpWage company = new CompanyEmpWage(wagePerHr, maxWorkingDays, maxWorkingHrs);
        companies.add(company);
        Integer put = totalEmpWages.put("0");
    }
    ...
    int calculateTotalWage(CompanyEmpWage companyEmpWage)
    {
        ...
        totalEmpWages.put(companyEmpWage.totalEmpWage);
